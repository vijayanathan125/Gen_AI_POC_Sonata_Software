    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Login(LoginRequest request)
        {
            try
            {
                ...
                //const string userEmail1 = "premium-user@example.com";
                //const string userPassword1 = "premium-user-password";
                ...
                //else if(request.UserMail== userEmail1 && request.Password == userPassword1)
                //{
                //    isPremium=true;
                //}
                else
